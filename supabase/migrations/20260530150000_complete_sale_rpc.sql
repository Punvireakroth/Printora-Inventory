-- Atomic POS sale: sales, sale_items, stock deduct, movements (SALE)
...
BEGIN
  ...
  -- Pre-check duplicates before locking products
...
GRANT EXECUTE ON FUNCTION public.complete_sale(public.payment_method, public.locale_code, jsonb) TO authenticated;
