-- Read-only list view for stock movement history.
-- Old/new stock are derived from products.current_stock: the latest movement's
-- new_stock equals current_stock; each row shows before/after for that change.
